...
if(getParam(3)=="integre"){
	...
	Query("UPDATE inscriptions SET type='1' WHERE id_site='$id_site'");
...
<form action="/mods/perso/inscription/<?=$id_site?>" method="post">
	...
	Sur cette page, incluez la balise <i>[WT:inscription]</i> ou le mod <i>[Mod Inscription]</i>.<br />
...
<br />
<code>
	&lt;a <?=HTTP_PUBLIC;?>modules/inscriptionv2/<?=$id_site;?>&gt;Inscrivez vous !&lt;/a&gt;
</code><br /><br />
<a href="/mods/perso/inscription/<?=$id_site?>/integre">-> Passer en mode page seule</a>
