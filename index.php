...
$connect = mysql_connect(SQL_HOST.":".SQL_PORT, SQL_USERNAME, SQL_PASSWORD) or exit("Erreur...");
$connect = @mysql_select_db(SQL_BDD, $connect) or exit("Erreur 2...");
...
if(MAINTENANCE == true && $verif_api != API_KEY && getParam(-1) != "maintenance" && $_SERVER['REMOTE_ADDR'] != gethostbyname('monpoke.dyndns.org')){
